...
# Find the possible venues that are wheelchair accessible, in Toronto, and can fit
# at least 150 people. These results should be stored in an array.

wheelchair = venues.select do |venue|
